    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
            ...
            <p class="text-gray-600 leading-relaxed">
                Le Liège Hackerspace s'appuie sur un réseau de partenaires, soutiens et amis qui partagent nos valeurs d'ouverture, d'innovation et de partage des connaissances. Leur engagement, qu'il soit matériel, financier ou simplement humain, contribue à faire vivre le lieu.
            </p>
            <p class="text-gray-600 leading-relaxed mt-3">
                Vous aussi, vous pouvez <a href="/soutenir" class="link-yellow">soutenir le Liège Hackerspace</a>.
            </p>
        </div>
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-6 items-center">
                ...
                <a href="https://floressence.eu/" class="flex items-center justify-center h-10 grayscale hover:grayscale-0 transition-all opacity-60 hover:opacity-100" target="_blank" rel="noopener">
                    <img src="/images/partenaires/floressence.svg" alt="Floressence" class="max-h-full max-w-full w-auto object-contain">
                </a>
