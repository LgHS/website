<article class="mb-6">
    ...
    <div class="leading-relaxed">
        ...
        <p>
            Les hackerspaces sont à différencier des FabLabs devenus un terme fourre-tout, utilisé pour désigner aussi bien des FabLabs, MakerSpaces, TechShops, HackerSpaces,... <a href="https://web.archive.org/web/20220122011958/https://fr.flossmanuals.net/fablab-hackerspace-les-lieux-de-fabrication-numerique-collaboratif/introduction/" title="FossManual Archive" target="_blank" rel="noopener" />Flossmanuals</a> résume très bien les différences entre ces lieux.
        </p>
        <h4>Lieu indépendant</h4>
        <p>
            Le financement provient majoritairement des membres et de nos différentes activités (projets, workshops, ...), ainsi que de quelques super sponsors privés qui garantissent notre autonomie et notre indépendance, et de rares aides publiques, mineures.
        </p>
    </div>
</article>